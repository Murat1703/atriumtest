...
const tabsButtons = document.querySelectorAll('.place-link');
...
tabsButtons.forEach(btn => {
  ...
  btn.addEventListener('click', () => {
    ...
    const prevActiveItem = document.querySelector('.places._active');
    // Получаем предыдущую активную вкладку
    const prevActiveButton = document.querySelector('.place-link._active');
